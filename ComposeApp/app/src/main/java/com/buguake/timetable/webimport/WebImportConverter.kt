...
import com.buguake.timetable.schedule.ParsedCourse
import com.buguake.timetable.schedule.ParsedEntry
...
object WebImportConverter {
    ...
    fun semesterStartMillis(date: LocalDate): Long =
        com.buguake.timetable.data.WeekCalculator.mondayOfWeek(date, 1)
