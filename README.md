...
> v1.6 亮点：全新「校园贴纸风」界面，与官网同款设计语言，亮/暗双主题重做；课表去网格线：课程块变贴纸卡片，直接落在纸面上；新增按日期调课：把某天的课整日调到另一日期，支持跨周，落点直接覆盖；全部图标重绘为纸绘线稿风格，桌面快捷方式图标同步更新；二级/三级页右滑返回全应用统一；悬浮岛切换动效升级：预备-主动作-跟随三段编排；R8 代码压缩与资源收缩：APK 约 24MB 降至 2.5MB，冷启动更快；修复暗色模式下深蓝文字与描边可读性问题；隐私政策与说明文档全面更新（声明可对照源码核验）。
