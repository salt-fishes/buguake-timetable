# 第三方组件与代码来源声明（THIRD PARTY NOTICES）

本项目"不挂科课表"在开发过程中参考/复制了以下第三方开源项目的部分内容，
按其许可证要求在此声明。

## 1. 拾光课程表（shiguangschedule）
...
```
   ...
   1. Definitions.
      ...
      "Legal Entity" shall mean the union of the acting entity and other
